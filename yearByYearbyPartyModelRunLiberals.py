...
words in Hansard by Liberal MPs.  
...
for x in range(0,106):
    ...
    hansardSpeechesDated = hansardSpeechesFull[(hansardSpeechesFull['speechdate'] > datetime.date(minYear,1,1)) & (hansardSpeechesFull['speechdate'] < datetime.date(maxYear,1,1)) & (hansardSpeechesFull['speakerparty']=='Liberal')]
    ...
    modelID = 'lipadLiberal%d' % startYear
